...
module.exports = (app, upload) => {
    ...
    app.post("/api/notifications/admin/adoption", authenticateJWT, notificationController.notifyAdminsOnNewAdoption);
    app.post("/api/notifications/user/adoption", authenticateJWT, notificationController.notifyUserOnAdoptionUpdate);
    ...
    app.post('/api/submit/feedback', adoptionController.submitFeedback);
    ...
    app.put('/api/pet/update-status/:id', authenticateJWT, petController.updatePetStatus);
