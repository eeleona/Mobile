...
const AdoptAPet = ({ navigation }) => {
  ...
  const handleAdopt = () => {
    navigation.navigate('Adoption Form');
  };
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <Text style={styles.heading}>Adopt A Pet</Text>
      </View>
      <View style={styles.filterC}>
        <TouchableOpacity style={styles.filter}>
          <Text style={styles.filterlabel}>All Pets</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.filter}>
          <Text style={styles.filterlabel}>Cats</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.filter}>
          <Text style={styles.filterlabel}>Dogs</Text>
        </TouchableOpacity>
      </View>
      ...
      <Portal>
        <Modal style={styles.mContainer} visible={visible} onDismiss={hideModal} contentContainerStyle={containerStyle}>
          ...
          <View style={styles.btnC}>
            <TouchableOpacity style={styles.btn} onPress={handleAdopt}>
              <Text style={styles.btnlabel}>Adopt</Text>
            </TouchableOpacity>
          </View>
        </Modal>
      </Portal>
