  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName='Login'>
        {/* SUPER ADMIN BOTTOM NAVIGATIONS */}
        ...
        <Stack.Screen name="View Staff" component={StaffDetails} options={{ headerShown: false }}/>
        <Stack.Screen name="View Admin" component={AdminDetails} options={{ headerShown: false }}/>
